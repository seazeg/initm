 ...
 * @LastEditTime : 2023-01-11 16:46:43
 * @Description  :
...
const PATH_CONFIG = {
    entry: {
        html: {
            dev: "src/pages/**/*.{html,shtml,htm}",
            prod: [
                "src/template/**/*.{html,shtml,htm}",
                "src/shredder/**/*.{html,shtml,htm}",
            ],
        },
        styles: [
            "src/pages/**/*.{less,css}",
...
const TASK = {
    DEV: {
        ...
        STYLE: {
            MAIN: "dev-css",
            CONCAT: "dev-css-concat",
        },
        SCRIPT: {
            MAIN: "dev-js",
            CONCAT: "dev-js-concat",
        },
        IMAGE: {
            MAIN: "dev-image",
            base64: "dev-base64",
    ...
    BUILD: {
        ...
        STYLE: {
            MAIN: "build-css",
            CONCAT: "build-css-concat",
        },
        SCRIPT: {
            MAIN: "build-js",
            CONCAT: "build-js-concat",
        },
        IMAGE: {
            MAIN: "build-image",
            base64: "build-base64",
